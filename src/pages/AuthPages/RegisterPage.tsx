...
import {validEmail, validName, validPassword} from "../../configs/vallid.config.ts";
...
const RegisterPage: FC = () => {
  const { register, handleSubmit, formState } = useForm<IRegisterForm>({ mode: "onChange" })
  ...
  const onSubmit: SubmitHandler<IRegisterForm> = async (data) => {
    ...
    <div className={styles.wrapper}>
      <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
        ...
        <p className={styles.text}>Уже зарегистрированы? <Link className={styles.link} to="../login/">Войдите</Link></p>
      </form>
    </div>
	)
}
